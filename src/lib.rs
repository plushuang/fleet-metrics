...
/// assert_eq!(fleet_metrics::total_num_cpus(&mut sys), Ok(16));
/// ```
...
/// use sysinfo::{Components, Disks, Networks, System};
/// let mut sys: System = System::new_all();
/// assert_eq!(fleet_metrics::used_num_cpus(&mut sys), Ok(16));
/// ```
...
/// use sysinfo::{Components, Disks, Networks, System};
/// let mut sys: System = System::new_all();
/// assert_eq!(fleet_metrics::total_memory(&mut sys), Ok(16));
/// ```
...
/// use sysinfo::{Components, Disks, Networks, System};
/// let mut sys: System = System::new_all();
/// assert_eq!(fleet_metrics::available_memory(&mut sys), Ok(7233028096));
/// ```
...
/// use sysinfo::{Components, Disks, Networks, System};
/// let mut sys: System = System::new_all();
/// assert_eq!(fleet_metrics::total_space(&mut sys), Ok(1254954610688));
/// ```
...
/// use sysinfo::{Components, Disks, Networks, System};
/// let mut sys: System = System::new_all();
/// assert_eq!(fleet_metrics::available_space(&mut sys), Ok(866847330304));
/// ```
